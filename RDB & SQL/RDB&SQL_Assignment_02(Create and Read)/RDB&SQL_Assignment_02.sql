...
----- 2. Conversion Rate
-- :Below you see a table of the actions of 
--  customers visiting the website by clicking on two different types of advertisements given by an E-Commerce company.
